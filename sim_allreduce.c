...
const char HELP_STRING[] =
        ...
        "        0 - None - no keep-alive messages at all (default)\n"
        "        1 - Randomized Service Distance (RSD) function\n"
        "        2 - Determenistic Interval Service Distance (DISD) function\n\n"
